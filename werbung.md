...
Werbeanzeigen werden dabei personalisiert ausgeliefert. Wie diese geschieht, kann selbst bestimmt werden:

![Ausschnitt Ad-Editor](img/adeditor-top.webp)
...
## Regeln graphisch erstellen

Die Regeln lassen sich ähnlich der Suche zusammenklicken, wenn der Hub nicht nur SQL, sondern auch die Suche verwenden darf:

![graphischer Ad-Editor](img/adeditor-gui.webp)

## Regeln mit SQL erstellen
